// ═════════════════════════════════════════════════════════════════
// FILE 1: JoinWithIdCompleteTeamsTest.java
// ═════════════════════════════════════════════════════════════════
...
public class JoinWithIdCompleteTeamsTest extends BaseTest {
    ...
    @Test(priority = 1)
    public void TC_Teams_001() throws Exception {
        header(1);
        run(1);
    }

    @Test(priority = 2, dependsOnMethods = "TC_Teams_001")
    public void TC_Teams_002() throws Exception {
        header(2);
        run(2);
    }

    @Test(priority = 3, dependsOnMethods = "TC_Teams_002")
    public void TC_Teams_003() throws Exception {
        header(3);
        run(3);
    }

    @Test(priority = 4, dependsOnMethods = "TC_Teams_003")
    public void TC_Teams_004() throws Exception {
        header(4);
        run(4);
    }

    @Test(priority = 5, dependsOnMethods = "TC_Teams_004")
    public void TC_Teams_005() throws Exception {
        header(5);
        run(5);
    }

    @Test(priority = 6, dependsOnMethods = "TC_Teams_005")
    public void TC_Teams_006() throws Exception {
        header(6);
        run(6);
    }

    @Test(priority = 7, dependsOnMethods = "TC_Teams_006")
    public void TC_Teams_007_Report() throws Exception {
        report();
    }
    ...
    private void run(int i) throws Exception {
        ...
        try {
            ...
            p.clickMicrosoftTeams();
            System.out.println("✓ Teams selected");
            Thread.sleep(2000);
    ...
    private void header(int i) {
        System.out.println("\n" + "═".repeat(70));
        System.out.println("TEAMS ITERATION " + i + " OF 6");
        System.out.println("═".repeat(70));
    }

    private void report() {
        System.out.println("\n" + "═".repeat(70));
        System.out.println("FINAL REPORT - TEAMS");
        System.out.println("═".repeat(70));
